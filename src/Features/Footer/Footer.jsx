...
const Features=["Link Shortening" , "Branded Links" , "Analytics"]
  ...
  return (
    <div className="bg-colors-natural_400  flex flex-row-reverse justify-between items-start p-10">
      <div className="flex h-32 p-2 gap-2">
        ...
        <div className="flex flex-col  ">
          <p className="text-colors-white font-Medium">Company</p>
          {
            companies.map((item)=>(
        ...
        <div>
          <p className="text-colors-white font-Medium text-2xl ">Shortly</p>
        </div>
    </div>
  );
};
